...
export const ServiceHistoryHero: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      >
        <Image
          src={AllImages.pool2}
          alt="Pure Pool certified service history"
          fill
          priority
          sizes="100vw"
      ...
      <Container className="relative z-10 w-full">
        <div ref={contentRef} className="flex flex-col gap-3 max-w-3xl">
          ...
          <p className="hero-desc text-base sm:text-lg text-white/85 font-normal leading-relaxed max-w-2xl">
            View detailed records of your pool service visits, including water diagnostics,
            certified technician work performed, and complete chemistry history.
          </p>
        </div>
      </Container>
    </section>
...
export default ServiceHistoryHero;
