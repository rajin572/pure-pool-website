  ...
  return (
    ...
    >
      ...
      >
        <Image
          src={AllImages.pool4}
          alt="Pure Pool billing and invoice management"
          fill
          priority
          sizes="100vw"
      ...
      <Container className="relative z-10 w-full">
        <div ref={contentRef} className="flex flex-col gap-3 max-w-3xl">
          ...
          <p className="hero-desc text-base sm:text-lg text-white/85 font-normal leading-relaxed max-w-2xl">
            Manage your ongoing maintenance plan, view official VAT tax receipts,
            track outstanding balances, and configure payment methods.
          </p>
        </div>
      </Container>
    </section>
