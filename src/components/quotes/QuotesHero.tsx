...
export const QuotesHero: React.FC = () => {
    ...
    >
      ...
      >
        <Image
          ...
          alt="Pure Pool quotes and proposal estimates"
          fill
          priority
          sizes="100vw"
      ...
      <Container className="relative z-10 w-full">
        <div ref={contentRef} className="flex flex-col gap-3 max-w-3xl">
          ...
          <p className="hero-desc text-base sm:text-lg text-white/85 font-normal leading-relaxed max-w-2xl">
            Review technician repair estimates, authorize equipment replacement parts with guaranteed 2-year warranties, and track installation scheduling.
          </p>
        </div>
      </Container>
    </section>
